// Package dashboard implements the management API (JSON/HTTP) for CRUD
// operations on ilter resources: API keys, groups, users, prompts,
// guardrails, MCP servers, MCP grants, OpenAPI specs, jobs, and runtime
// config.
//
// Relationship with admin/: admin/ is the machine-facing JSON API for
